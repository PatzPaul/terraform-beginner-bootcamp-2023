...
Provisioners allow you execute commands on compute instances eg, a AWS CLI command.
...
This will execute the command on the machine running the terraform commmands eg. plan apply
```tf
